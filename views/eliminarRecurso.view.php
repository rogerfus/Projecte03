...
<?php
		...
		echo "<form action='procEliminarRecurso.php'>
		Está a punto de eliminar el recurso ". $rec_name. ". Esta acción es <strong>PERMANENTE.</strong><br><br>
		¿Está usted seguro? Recuerde que puede <a href='administrarRecursos.php' style='color:orange'>inhabilitarlo.</a>
		<input type='hidden' name='rec_id' value='$rec_id'><br><br>
		<input type='submit' style='color:red' value='Sí, eliminar definitivamente.'>
		";
	?>		
