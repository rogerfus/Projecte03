		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>Disponibilidad de recursos</h2> <br>
...
<?php
	$conexion = mysqli_connect('localhost', 'root', '', 'bd_cromo');
		...
		if(mysqli_num_rows($usuarios)!=0){
			echo "<h3> Número de recursos: " . mysqli_num_rows($usuarios) . "</h3>";?><h3><a href="afegirUsuari.php">Añadir un usuario</a></h3><?php
			while($usu = mysqli_fetch_array($usuarios)){
			$usu_name = $usu['usu_name'];$usu_pass=$usu['usu_pass'];?> 
				<form method="post" name="Form" id="Form" action="modificarAlgunUsuario.php">
		<dl>
			
			<dd><input type="text" name="usu_name" value="<?php echo $usu_name;?>" />
			<input type="password" id="pass" name="pass" value="$usu_pass" />
		
			<button type="reset">Reset</button>
			<button type="submit">Submit</button></dd>
		</dl>
